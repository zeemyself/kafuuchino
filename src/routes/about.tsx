      ...
      <div className="px-8 py-16 text-center bg-gradient-to-r from-purple-50 to-blue-50">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
            Kafuuchino is more than just a web application—it's a showcase of modern web development 
            practices, beautiful design, and cutting-edge technology stack.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 p-8 md:p-12">
            ...
            <div className="prose prose-lg mx-auto text-gray-600">
              <p className="mb-6">
                We believe in creating web experiences that are not only functional but also delightful. 
                Kafuuchino demonstrates how modern tools can come together to create something beautiful 
                and performant.
              </p>
              <p>
                Every line of code is written with care, every component is crafted with attention to detail, 
                and every interaction is designed to provide the best possible user experience.
              </p>
            </div>
          </div>
        </div>
      ...
      <div className="px-8 py-16 bg-gray-50">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">Built with the best tools in the ecosystem</p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 text-sm">The latest version of React with improved performance and new features</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 text-sm">Type-safe router with powerful features for modern React applications</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 text-sm">Powerful data synchronization for React applications</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 text-sm">Type safety and excellent developer experience</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <p className="text-gray-600 text-sm">Code quality and consistency with modern linting rules</p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-100 p-6 text-center hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              ...
              <h3 className="text-lg font-semibold text-gray-800 mb-2">Modern Tooling</h3>
              <p className="text-gray-600 text-sm">Latest development tools for the best developer experience</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-2xl shadow-xl text-white p-8 md:p-12">
            <div className="text-center mb-8">
              ...
              <p className="text-blue-100">Some impressive numbers about our project</p>
            </div>
