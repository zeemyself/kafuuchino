...
function TDGauge({ value }: { value: number }) {
    ...
    return (
        <div className="flex items-center gap-3 w-full max-w-[200px]">
            ...
            <span className="text-sm font-bold text-gray-700 dark:text-gray-300 tabular-nums w-10 text-right">{value.toFixed(1)}</span>
        </div>
    )
}

function SortIcon({ active, dir }: { active: boolean; dir: SortDir }) {
    if (!active) return <div className="w-4 h-4 text-gray-300 dark:text-gray-600 opacity-0 group-hover:opacity-50 transition-opacity">↕</div>
    return (
        ...
        <div className="min-h-screen bg-gray-50/50 dark:bg-slate-900/50 font-sans text-gray-900 dark:text-gray-100 transition-colors duration-200">
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 -mt-8">
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl shadow-gray-200/50 dark:shadow-black/20 border border-gray-100 dark:border-gray-700 p-6 mb-8 backdrop-blur-xl bg-white/80 dark:bg-slate-800/80 relative z-10 transition-colors duration-200">
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6">
                        ...
                        <div className="md:col-span-4">
                            <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">Search</label>
                        ...
                        <div className="md:col-span-4">
                            <label className="block text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2">
                                TD Range <span className="text-gray-400 ml-1">({tdRange[0]} - {tdRange[1]})</span>
                            </label>
                    ...
                    <div className="mt-6 pt-6 border-t border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row justify-between items-center gap-4">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm font-medium text-gray-500 dark:text-gray-400">
                                Avg TD: <span className="text-gray-900 dark:text-gray-100">{avgTd.toFixed(1)}</span>
                            </span>
                        </div>
                ...
                <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden transition-colors duration-200">
                            ...
                            <tbody className="divide-y divide-gray-100">
                                {filteredAndSorted.map((filament, index) => (
                                    ...
                                    >
                                        ...
                                        <td className="px-6 py-4 whitespace-nowrap">
                                            <span className="text-sm font-medium text-gray-900 dark:text-gray-100">{filament.brand}</span>
                                        </td>
                                        <td className="px-6 py-4 whitespace-nowrap">
                    ...
                    <div className="md:hidden divide-y divide-gray-100 dark:divide-gray-700">
                        ...
                        <div className="p-4 bg-gray-50 dark:bg-slate-700/50 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                            <span className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase">Sort By</span>
                            <select
                        ...
                        {filteredAndSorted.map((filament, index) => (
                            <div key={`${filament.brand}-${filament.color}-${index}`} className="p-5 hover:bg-gray-50 dark:hover:bg-slate-700/50 transition-colors">
                                <div className="flex items-start justify-between mb-4">
                                    <div>
                                        <div className="flex items-center gap-2 mb-1">
                                            <h3 className="text-base font-bold text-gray-900 dark:text-gray-100">{filament.brand}</h3>
                                    ...
                                    <div className="text-right">
                                        <div className="text-2xl font-bold text-gray-900 dark:text-gray-100 tracking-tight">{filament.td}</div>
                ...
                <div className="mt-8 flex items-start gap-3 p-4 rounded-xl bg-yellow-50/50 dark:bg-yellow-900/20 border border-yellow-100 dark:border-yellow-900/30 text-yellow-800 dark:text-yellow-200 text-sm">
                    <svg className="w-5 h-5 flex-shrink-0 text-yellow-600 dark:text-yellow-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
